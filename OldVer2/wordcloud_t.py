...
def wordcloudt():
    ...
    # 1、读入txt文本数据
    text = open(r'file2.txt', "r", encoding='UTF-8').read()
    jieba.load_userdict('jbdict.txt')
    ...
    wc = WordCloud(font_path=r"YaHei.ttf", background_color='white', width=800,
                   height=600, max_font_size=50,
                   max_words=5000)  # ,min_font_size=10)#,mode='RGBA',colormap='pink')
    wc.generate(result)
